...
class Actor_Critic(nn.Module):
    """
    This Actor-Critic class is a 3 layer fully connected neural network used in the PPOAgent class below.
    ...
    The critic evaluates our agent's action choices (value function)
    """
...
class PPOAgent:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.actor = Actor_Critic(state_size, action_size, HIDDEN_SIZE, torch.tanh).to(DEVICE) # separate networks for the actor and the critic
        self.critic = Actor_Critic(state_size, 1, HIDDEN_SIZE).to(DEVICE)
    ...
    def evaluate(self, state, action):
        """
        This evaluates the current policy and value function for given states and actions for training
