...
## ActorNetwork Neural Network

class ActorNetworkNetwork(nn.Module):
    """
    ...
    def __init__(self, input_size = 24, output_size = 2, hidden_sizes = [400, 300]):
        super(ActorNetworkNetwork, self).__init__()
...
## CriticNetwork Neural Network

class CriticNetworkNetwork(nn.Module):
    """
    The critic network
    ...
    def __init__(self, state_size = 48, action_size = 4, hidden_sizes = [400, 300]):
        super(CriticNetworkNetwork, self).__init__()
